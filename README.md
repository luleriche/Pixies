...
Celles-ci vous rapportent des points en fonction de leur chiffre, de leur couleur et des symboles dessus.
...
2. Ce même emplacement ne contient qu'une carte face visible, c'est à vous de choisir laquelle des deux reste visible.L'autre sera placée face cachée en dessous, l'emplacement sera désormais dit validé et plus aucune carte ne pourra y aller.
3. L'emplacement où doit aller la carte est déja validé, c'est à dire qu'il contient déjà deux cartes, dans ce cas,placez la carte tirée face cachée à l'emplacement vide de votre choix. 
